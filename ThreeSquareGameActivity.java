...
/*Initialize ThreeSquareGameActivity extending fromm AppCompatActivity
* Also implement {@View.OnClickListener} for all onClickListener views below*/
public class ThreeSquareGameActivity extends AppCompatActivity implements View.OnClickListener {

    /*initialize player turn buttons/player turn count and score count for X and O*/
    boolean player_x;
    ...
    * Also initialize/define board condition as integer value*/
    ...
    TextView scoreBoxTV1; TextView scoreBoxTV2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoreBoxTV1 = (TextView) findViewById(R.id.p1_score);
        scoreBoxTV2 = (TextView) findViewById(R.id.p2_score);

        //Get EditText String and display on appropriate text view
    ...
    * e.g. Player X wins, First Row*/
    private void getWinner(){
        ...
        Log.d("ThreeSquareGameActivity", + scoreX + "Shubambam");
    }
    ...
    * initialize player count to zero*/
    private void resetBoard(){
        ...
        setScoreWinner("Board Reset");
        setScoreDetails("Play Another Game");
    ...
    //Set text view to display score of player X
    private void addScorePlayerOne(int scoreX){
        scoreBoxTV1.setText(String.valueOf(scoreX));
    }

    //Set text view to display score of player O
    private void addScorePlayerTwo(int scoreO){
        scoreBoxTV2.setText(String.valueOf(scoreO));
    }
